...
if __name__ == '__main__':
    ...
    for run in range(start, end+1):
        if run==1:
            ...
            args = Args(input_data='set2000.h5',  run=run, focal_loss_ag=None,       dilate=0)
        elif run==5:
            args = Args(input_data='set2000.h5',  run=run, focal_loss_ag=(0.99,2.0), dilate=0)
        elif run==6:
            args = Args(input_data='set2000.h5',  run=run, focal_loss_ag=(0.99,4.0), dilate=0)
        elif run==7:
            args = Args(input_data='set2000.h5',  run=run, focal_loss_ag=(0.9,4.0),  dilate=0)
